...
const Rooms = () => {
  ...
  const handleCreateRoom = (roomData) => {
    axios.get('https://smartexamhub.vercel.app/room/refresh-rooms', roomData)
      .then((response) => {
  ...
  const handleDeleteRoom = (room_id) => {
    ...
    if (confirmDelete) {
      axios
        .delete(`https://smartexamhub.vercel.app/room/room/${room_id}`)
        .then((response) => {
  ...
  return (
    <div>
      <div className="grid grid-cols-2 md:grid-cols-2 md:grid-rows-2 lg:grid-cols-4 lg:grid-rows-1 gap-4">
