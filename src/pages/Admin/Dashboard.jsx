...
const Dashboard = () => {
    ...
    useEffect(() => {
      ...
      axios.get('https://smartexamhub.vercel.app/users/user-stats') // Adjust the URL accordingly
        .then((response) => {
    ...
    return (
        <div className='dash'>
            ...
            <div className='grid grid-cols-2 sm:grid-rows-2 md:grid-cols-2 md:grid-rows-2 lg:grid-cols-3 lg:grid-rows-1 gap-5'>
            ...
            <div className='flex flex-col md:flex-row md:gap-6 mt-[16px] w-full'>
                <div className='basis-[100%] border-2 border-slate-700 bg-white shadow-md cursor-pointer rounded-[4px] dark:bg-slate-900'>
