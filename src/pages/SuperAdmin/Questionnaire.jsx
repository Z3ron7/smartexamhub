...
const Questionnaire = () => {
          ...
          if (selectedCompetency?.value === 'All Competency') {
            ...
            if (competencyData) {
              ...
              response = await axios.get(
                `https://smartexamhub.vercel.app/questions/fetch?program=${selectedProgram.label || ''}&competency=${selectedCompetency.value || ''}&search=${searchQuery}`
              );
  ...
  const handleDelete = (questionId) => {
    ...
    axios
      .delete(`https://smartexamhub.vercel.app/questions/delete/${questionId}`)
      .then((response) => {
